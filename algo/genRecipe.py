...
Run this file (python genRecipe.py)
and follow the Instructions to generate a
bunch of tasknodes. These will automatically
be put in the SQLlite Database. You can then
test a query of the database using genTaskList.py
(Instructions included in source code)
...
def main():
	...
	end_loop = False
	list_of_operators = gDBMgr.fetch_operators()
