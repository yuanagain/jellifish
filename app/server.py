...
class Server(Flask):
	...
	def configureRoutes(self):
		...
		def get_timers():
			...
			timer_data = {"active": [{"start_time": 0.0, "description": "Put water in pot. Put pot on stove", "name": "Put water on stove", "duration": 5}, {"start_time": 5.0, "description": "Add salt to water", "name": "Add salt", "duration": 10}, {"start_time": 15.0, "description": "Add pasta to boiling water", "name": "Put pasta in water", "duration": 10}, {"start_time": 25.0, "description": "Dice Tomatoes into small cubes", "name": "Dice Tomatoes", "duration": 10}, {"start_time": 35.0, "description": "Drain pasta using a strainer", "name": "Drain pasta", "duration": 15}, {"start_time": 50.0, "description": "Cover the pasta with Tomatoes", "name": "Put Tomatoes in pasta", "duration": 5}], "passive": [{"name":"Boiling Water\n","end_time":7.0,"start_time":0.0,"descripton":"Bring cold water to a boil\n","duration":7.0},{"name":"Pasta\n","end_time":120.0,"start_time":120.0,"descripton":"Ingredient\n","duration":0.0},{"name":"Water\n","end_time":120.0,"start_time":120.0,"descripton":"Ingredient\n","duration":0.0}, {"start_time": 2.0, "duration": 28.0, "name": "Watch pasta", "description": "none"}]}
